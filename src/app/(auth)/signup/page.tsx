...
export default function SignupPage() {
  ...
  // To re-enable the actual signup form:
      ...
      <div className="w-full max-w-md">
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>Enter your details to get started with WorkWise</CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardFooter className="justify-center text-sm">
            <p>Already have an account? <Link href="/" className="font-semibold text-primary underline-offset-4 hover:underline">Sign in</Link></p>
          </CardFooter>
        </Card>
      </div>
    </div>
